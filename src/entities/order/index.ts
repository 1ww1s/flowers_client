...
export { zones } from "./lib/assets/zones";
...
export {type IOrderItem, type TMethodOfReceipt, type IZone, type TMethodPayment, type IOrderReq, type IOrderRes} from './model/types'