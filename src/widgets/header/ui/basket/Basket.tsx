...
import { BASKET_ROUTE, MY_BASKET_ROUTE } from "../../../../app/router/routes";
...
export const Basket: FC<IBasket> = ({user}) => {

    const {pathname, search} = useLocation()

    return (
        <Link to={user.isAuth ? MY_BASKET_ROUTE.path : BASKET_ROUTE.path} state={pathname+search}>
            <figure className={classes.info}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M8.25 6.75C8.25 5.75544 8.64509 4.80161 9.34835 4.09835C10.0516 3.39509 11.0054 3 12 3C12.9946 3 13.9484 3.39509 14.6517 4.09835C15.3549 4.80161 15.75 5.75544 15.75 6.75" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                 <figcaption className={classes.numb}> 
                    <NumbItems numb={user.basket.length} />
                </figcaption>
            </figure>
        </Link>
    )
